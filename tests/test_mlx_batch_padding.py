...
def test_segments_reach_the_composer_by_buffer_not_by_capture():
    import mlx.core as mx

    from unsloth_zoo.mlx.compile import (
        SegmentMaskBuffers, make_segment_mask_composer,
    )
...
def test_disengaging_leaves_attention_untouched():
    import mlx.core as mx
